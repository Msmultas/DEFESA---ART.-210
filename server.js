...
app.post('/gerar-pdf', (req, res) => {
  ...
  doc.fontSize(14).font('Helvetica').text(' venho através deste apresentar defesa-prévia escrita, conforme disciplina o art. 210 do Código de Trânsito Brasileiro:', { align: 'left' });
  doc.moveDown();
...
doc.image('./imagens-doc/foto5.png', { //caminho da imagem
...
doc.moveDown();
  ...
  doc.fontSize(14).font('Helvetica').text('A titulo de exemplo verifica-se que o art. 210 do CTB, com base na observância do MBFT, prevê no campo “Quando Autuar” a possibilidade de imputação de penalidade em várias possibilidades, ou seja, prevendo condutar distintas.', { align: 'left' });
  doc.moveDown();
